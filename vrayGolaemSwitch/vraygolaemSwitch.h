...
{
#define	VRAYDIRT_CLASS_ID Class_ID(0x3ae8c64c, 0xe585959)
...
public:
	...
	void Reset();
	Interval Validity(TimeValue t) { Interval v; Update(t,v); return _ivalid; }
...
public:
	...
	Class_ID ClassID(void) { return VRAYDIRT_CLASS_ID; }
