...
The Golaem cache has no preview whatsoever in the viewport; there is just a basic sphere icon to show the object in the scene. The actual transformation of the object in the 3ds Max scene is ignored - Golaem generates everything directly in world space.
